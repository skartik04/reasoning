#!/usr/bin/env python3
"""
Temporary script to run scripts/inference/waluigi_generation.py with all models sequentially.
...
def run_model(model_name, script_path):
    """Run scripts/inference/waluigi_generation.py with a specific model."""
...
def main():
    ...
    script_path = 'scripts/inference/waluigi_generation.py'
