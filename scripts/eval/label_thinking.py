...
Reuses functions from reasoning.harmful_response_generator to avoid code duplication.
"""
...
from reasoning.harmful_response_generator import (
...
if __name__ == "__main__":
    ...
    input_file = "artifacts/results/analysis/harmful_inference_Qwen_Qwen3-4B_offset120_400_labelled.json"  # Input labeled file
