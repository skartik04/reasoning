...
def main():
    ...
    judgment_results = []
    print("⚖️ Generating safety judgments...")
    ...
    for i, item in enumerate(tqdm(data, desc="Processing items")):
        ...
        try:
            ...
            print(f"📝 FORMATTED CLASSIFIER PROMPT:")
    ...
    output_dir = f'artifacts/responses/safety_judge/{model_folder_name}'
    ...
    print(f"✅ Safety judgment complete!")
