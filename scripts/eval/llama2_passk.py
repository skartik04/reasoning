...
if __name__ == "__main__":
    ...
    model_name = 'google/gemma-2b'  # Change this to any model you want
    # Other options:
    ...
    top_p = 0.9
    temperature = 0.7
    n = 2  # number of instructions to process from dataset
    seed = 42
    output_dir = "artifacts/results/residual_paper/k_responses_results"
    verbose = True
    ...
    instructions = load_dataset(dataset_path)
