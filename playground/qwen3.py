...
def instructions(thinking=True):
    instruction = (
        ...
        "Then, on the last line, write the final numeric answer prefixed by 'Answer:'"
    )
...
def main():
    ...
    # Save results
    with open("playground/qwen3_concise.json", "w") as f:
        json.dump(results, f, indent=2)
    
    print("Experiment completed! Results saved to qwen3_concise.json")
